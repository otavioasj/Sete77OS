<!-- gerado por scripts/sincronizar-skills.sh — edite skills/mapear-rotinas/SKILL.md -->
...
Ler `templates/skills/catalogo.md` pra ver se alguma das tarefas mencionadas já é coberta por uma skill nativa do Claude Code ou validada pelo Sete77OS. Se sim, sugerir a skill existente em vez de criar uma nova:
...
```
Criei [N] skills:
✓ /<nome1> — em skills/<nome1>/SKILL.md
✓ /<nome2> — em skills/<nome2>/SKILL.md
...
