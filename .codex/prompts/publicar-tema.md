<!-- gerado por scripts/sincronizar-skills.sh — edite skills/publicar-tema/SKILL.md -->
...
- **Skill carrossel:** `skills/carrossel/SKILL.md` — usar pra fase do carrossel
...
**Sem perguntar, partir direto pra criação do carrossel** chamando `skills/carrossel/SKILL.md` (tipo 1: carrossel texto puro).
