---
name: github-da-semana
description: >
  Cria um carrossel da série "IA na prática" do Instagram da marca: um projeto do GitHub ou uma
  skill que resolve algo no dia a dia, com foco em substituir ferramenta paga, mais o PDF que fica
  numa página do site e vai no primeiro comentário do post. Use quando o usuário disser "github da semana",
  "/github-da-semana", "post de IA", "post da noite" ou pedir conteúdo sobre projeto open source.
---
