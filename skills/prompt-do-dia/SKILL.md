...
name: prompt-do-dia
description: >
  Cria um carrossel da série "5 prompts pra [área]" do Instagram da marca: um tema, cinco prompts
  estruturados prontos pra copiar, mais o PDF que vai por DM pra quem comentar a palavra-chave.
  Use quando o usuário disser "prompt do dia", "/prompt-do-dia", "carrossel de prompts" ou pedir
  um post de prompt/IA.
---
